...
def apply_ttrl_gt(batch, gen_batch_output, n, tokenizer):
    ...
    majority_gt_list, signal_noise_ratio_list = _batch_majority_vote(model_outputs, n)
...
def _batch_majority_vote(model_outputs: List[str], n: int) -> tuple[List[str], List[float]]:
    ...
    for i in range(n_prompts):
        ...
        prompt_majority_gt, prompt_signal_noise_ratio = _majority_vote(prompt_outputs)

        majority_gt_list.append(prompt_majority_gt)
        signal_noise_ratio_list.append(prompt_signal_noise_ratio)

    return majority_gt_list, signal_noise_ratio_list
